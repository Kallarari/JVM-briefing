...
export default function Adm() {
  ...
  return (
    <>
      <Box display={disp ? "none" : "block"} pt="30vh">
        <Text
          fontSize="25px"
          color="black"
          textAlign="center"
          ...
          fontWeight="600"
        >
          Bem vindo João Vitor
        </Text>
        <Box bg="#aaa" borderRadius="8px" p="30px" w="40vw" mx="auto">
          <InputGroup w="30vw" mx="auto" display="block">
            <Text
              fontSize="20px"
              color="black"
              textAlign="center"
            ...
            <Input
              onChange={(e) => {
                if (e.target.value === "rubens") setDisp(true);
              }}
              type="text"
              placeholder="senha"
              bg="white"
